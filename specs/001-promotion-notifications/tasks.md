...
**Status**: T001–T015 are complete (namespace, setup and tested foundation). T016–T080 remain pending. Lifecycle discovery, delivery adapters and dispatch are not implemented; this is not a release-ready notification feature. Evidence is recorded in [implementation-validation.md](checklists/implementation-validation.md). Paths below are repository-relative.
